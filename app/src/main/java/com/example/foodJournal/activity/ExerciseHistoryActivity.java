...
public class ExerciseHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new ExerciseHistoryAdapter.OnItemClickListener() {
            ...
            public void onItemDeleteClick(int position) {
                ...
                mDatabase.delete(ExerciseHistorySchema.ExerciseHistoryEntry.TABLE_NAME, WHERE, null);
            }
        });
    ...
    private void addItem() {
        ...
        if (name.trim().length() == 0 || Integer.valueOf(amount) == 0 || Integer.valueOf(calorie) == 0) {
            return;
        }
